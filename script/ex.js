...
class Blob {
  ...
  render() {
    ...
    var img = new Image();
    img.src =
      "https://images.pexels.com/photos/6990619/pexels-photo-6990619.jpeg?cs=srgb&dl=pexels-ds-stories-6990619.jpg&fm=jpg";
    img.onload = function () {
      ...
      tCtx.drawImage(this, 0, 0, this.width, this.height, 0, 0, size, size);
...
*/
  ...
  get radius() {
    return this._radius || window.innerHeight / 2;
  }
